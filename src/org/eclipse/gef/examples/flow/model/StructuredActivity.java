...
public void addChild(Activity child, int index){
	System.out.println("creating a structured activity");
	
//	Task childTask;
//	Activity childActivity;
//	
//	if(child instanceof Activity){
//		childActivity = (Activity)child;
//		if (index >= 0) {
//			children.add(index,childActivity);
//		}	
//		else{
//			children.add(childActivity);
//		}	
//		fireStructureChange(CHILDREN, childActivity);
//	} else if (child instanceof Task){
//		childTask= (Task)child;
//		if (index >= 0) {
//			children.add(index,childTask);
//		}	
//		else{
//			children.add(childTask);
//		}	
//		fireStructureChange(CHILDREN, childTask);
//	}
